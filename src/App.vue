...
(async () => {
  ...
  const now = new Date();
  isDaytime.value = !!sunStatus.value?.sunrise && !!sunStatus.value?.sunset && new Date(sunStatus.value.sunrise).getTime() < now.getTime() && new Date(sunStatus.value.sunset).getTime() > now.getTime();
